...
class AppFixtures extends Fixture
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        // Tricks
        $trickArray = array(
            array('user_id' => '1','name' => 'Back Flip','description' => '1- Le mieux c’est de s’entrainer à le faire sur un trampoline car le mouvement est le même. 
